...
public class TrackingCameraDrinkingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayQuestions();
        loadingDialog = new LoadingDialog(TrackingCameraDrinkingActivity.this);
    ...
    public void submitAnswers() {
        ...
        if (allQuestionsAnswered) {
            ...
            ApiHelper.behaviorCamera(email, "drinking", imageFile, questions, new Callback() {
                @Override
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (response.isSuccessful()) {
                                Toasty.success(TrackingCameraDrinkingActivity.this, "Submit successfully!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(TrackingCameraDrinkingActivity.this, MainActivity.class);
                                ...
                                try {
                                    ...
                                    Toasty.error(TrackingCameraDrinkingActivity.this, errorMessage, Toast.LENGTH_SHORT).show();
                                } catch (JSONException | IOException e) {
                                    e.printStackTrace();
                                    Toasty.error(TrackingCameraDrinkingActivity.this, "Failed to submit.", Toast.LENGTH_SHORT).show();
                                }
                            }
