...
public class TrackingCameraEatingScreen1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void submitAnswers() {
        ...
        if (selectedRadioButton != null) {
            ...
            if (answer.equals("0")) {
                ...
                Intent intent = new Intent(this, TrackingCameraEatingScreen2Activity.class);
                intent.putExtra("photo", photo);
                intent.putParcelableArrayListExtra("userResponses", userResponses);
                startActivity(intent);
            }
