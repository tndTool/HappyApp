...
public class TrackingCameraEatingScreen3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracking_camera_eating_screen3);
    ...
    public void submitAnswers() {
        ...
        if (selectedRadioButton != null) {
            ...
            if (answer.equals("0")) {
                ...
                Intent intent = new Intent(this, TrackingCameraEatingScreen4Activity.class);
                intent.putExtra("photo", photo);
                intent.putParcelableArrayListExtra("userResponses", userResponses);
                startActivity(intent);
            }
