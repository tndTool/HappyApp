...
public class TrackingCameraEatingScreen4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracking_camera_eating_screen4);
    ...
    public void submitAnswers() {
        ...
        if (allQuestionsAnswered) {
            ...
            Intent intent = new Intent(this, TrackingCameraEatingScreen5Activity.class);
    ...
    private void showPopup() {
        ...
        builder.setMessage("If you had one snack in the last 4 hours, respond to the following questions about what you ate and the corresponding context. If you had more than one snack in the last 4 hours, choose the most recent one to respond to the questions.\n\nClick \"Next\" to start the questionnaire.");
